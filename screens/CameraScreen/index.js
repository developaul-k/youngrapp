...
class CameraScreen extends Component {
    ...
    render() {
        const { hasCameraPermissions, type, flash, picture, pictureTaken } = this.state;

        if (hasCameraPermissions === null) {
            return <View style={styles.container}></View>
        } else if ( hasCameraPermissions === false ) {
            return <View style={styles.container}><Text>No Access to Camera, Check your settings</Text></View>
        } else {
            return (
